...
Original file is located at
    https://colab.research.google.com/drive/1YuUX1zlrKKreiyL5ArF9gUEz4JzkIrNZ
...
1. To do so, create Roboflow account(https://app.roboflow.ai).
...
# %cd /content/darknet
!curl -L "https://app.roboflow.com/ds/pUGZaYRFdq?key=ULybY4Q3LW" > roboflow.zip; unzip roboflow.zip; rm roboflow.zip
